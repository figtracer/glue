...
Run npm run check and npm test. Payment changes need coverage for crash/retry, expiry, budget and no duplicate submission. Use mock payments unless the user explicitly authorizes a bounded live test.
